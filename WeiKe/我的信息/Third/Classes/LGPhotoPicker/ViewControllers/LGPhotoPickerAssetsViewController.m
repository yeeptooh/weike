...
- (UIButton *)sendBtn{
    if (!_sendBtn) {
        ...
        [rightBtn setTitleColor:color(38, 204, 144, 1) forState:UIControlStateNormal];
        [rightBtn setTitleColor:color(27, 178, 139, 1) forState:UIControlStateHighlighted];
...
- (UIButton *)previewBtn
{
    if (!_previewBtn) {
        ...
        [leftBtn setTitleColor:color(200, 200, 200, 1) forState:UIControlStateHighlighted];
...
- (void)addNavBarCancelButton{
    ...
    UIBarButtonItem *cancelItem = [[UIBarButtonItem alloc]initWithTitle:@"取消" style:UIBarButtonItemStylePlain target:self action:@selector(cancelBtnTouched:)];
