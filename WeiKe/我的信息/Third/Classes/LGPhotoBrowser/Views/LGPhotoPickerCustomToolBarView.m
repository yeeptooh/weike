                    ...
                    selectedCount:(NSInteger)count
{
    ...
    self.sendBtn.tintColor = color(27, 178, 139, 1);
    ...
    _toolbar.items = @[fixedItem, self.isOriginalBtn, fiexItem, self.sendBtn,fixedItem];
...
- (UIBarButtonItem *)createSelecteOriginalItemWithImg:(UIImage *)image
    ...
    button.frame = CGRectMake(0, 0, 75, 44.0f);
