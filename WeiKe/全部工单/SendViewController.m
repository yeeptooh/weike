...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text = self.stepList[indexPath.row][@"Text"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSDictionary *params = @{
                             ...
                             @"taskId":@(self.ID),
                             @"waiterId":self.stepList[indexPath.row][@"Value"]
                             };
    ...
    [manager POST:URL parameters:params success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        NSLog(@"weakSelf.presentingViewController=%@",weakSelf.presentingViewController);
        ...
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.75 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
            ...
            DetailTaskPlanViewController *detailVC = (DetailTaskPlanViewController *)[((UINavigationController *)weakSelf.presentingViewController) topViewController];
            
            
            [weakSelf dismissViewControllerAnimated:YES completion:^{
                [detailVC.navigationController popViewControllerAnimated:YES];
            }];
